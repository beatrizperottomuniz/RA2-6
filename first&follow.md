...
FIRST(op_stmt_stmt) = {DIV, EQ, GT, GTE, INT_DIV, KEYWORD_ELSE, KEYWORD_IF, LT, LTE, MINUS, MOD, MULT, NEQ, PLUS, POW}
FIRST(prog) = {LPAREN}
...
FOLLOW(stmt) = {DIV, EQ, GT, GTE, ID, INT_DIV, KEYWORD_ELSE, KEYWORD_FOR, KEYWORD_IF, LPAREN, LT, LTE, MINUS, MOD, MULT, NEQ, NUM_FLOAT, NUM_INT, PLUS, POW}
```